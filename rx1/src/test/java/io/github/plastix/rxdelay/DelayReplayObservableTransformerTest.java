...
public class DelayReplayObservableTransformerTest {
    ...
    public void setUp() {
        ...
        transformer = RxDelay.delayReplay(pauseLifecycle.asObservable());
    ...
    public void emitsTwoItemsUponMultipleReattachment() {
        ...
        testSubscriber.assertValueCount(3);
        testSubscriber.assertValues(0, 0, 1);
    ...
    public void emitsThreeItemsUponMultipleReattachment() {
        ...
        testSubscriber.assertValues(0, 0, 1, 2);
    }
